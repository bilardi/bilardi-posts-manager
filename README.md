# bilardi-posts-manager

My personal posts about talks and workshops.
...
Create a date folder under `posts/` and add `.md` files. The folder name is the event date.
...
```bash
bash /path/to/github-actions-publish/scripts/check-length.sh posts/2026-05-21/pre.md
```
...
posts/  # date folders with .md files
